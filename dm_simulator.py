...
from .c_interface import mapping
...
class DmSimulatorPy(BaseBackend):
    ...
    def _add_decoherence_and_amp_decay(self, level, f, p, g):
        ...
        self._densitymatrix = nlcpy.reshape(self._densitymatrix,
                                         self._number_of_qubits * [4])
    ...
    def _compute_densitymatrix(self, dmpauli):
        '''
            ...
            Optimized for memory efficiency by using NumPy's memmap to process large data in chunks.
        ...
        # Perform mapping efficiently without excessive memory allocation
        mapping(self._number_of_qubits, densitymatrix, densitymatrix_b)

        return np.array(densitymatrix)  # Convert back to NumPy array for retur
